...
class FTFeedRecipeTableViewModel {
    ...
    func createTableCellModel(recipeOverview: FTRecipeOverview) -> FTFeedRecipeTableCellViewModel {
        return FTFeedRecipeTableCellViewModel(recipeOverview: recipeOverview)
    }
