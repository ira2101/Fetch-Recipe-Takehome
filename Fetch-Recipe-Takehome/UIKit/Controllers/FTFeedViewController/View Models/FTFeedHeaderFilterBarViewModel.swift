...
class FTFeedHeaderFilterBarViewModel {
    ...
    func createItemModel(for category: FTCategory) -> FTFeedHeaderFilterBarItemViewModel {
        return FTFeedHeaderFilterBarItemViewModel(category: category)
    }
